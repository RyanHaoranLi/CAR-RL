...
def add_common_parser_opts(parser):
    ...
    parser.add_argument('--robust-soft-lambda', type=float, help='soft lambda for CAR-PPO')
    parser.add_argument('--robust-add-clean-loss', type=str2bool, help='add clean loss to CAR-PPO')
    parser.add_argument('--robust-ppo-reg-kl', type=float, help='CAR-PPO KL regularization')
