...
setup(
  ...
  description='Tools for Experiment Logging',
  long_description=long_description,

  # The project's main homepage.
  url='https://github.com/andrewilyas/cox',
  ...
  entry_points={
    'console_scripts': [
      'make-cox-experiments=cox.make_experiments:main',
      'study-to-cox=cox.from_study:main',
      'cox-tensorboard=cox.tensorboard_view:main',
      'cox-archive=cox.archive:main',
    ],
  }
)
